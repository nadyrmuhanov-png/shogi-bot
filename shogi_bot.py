...
MEMORY_TEST_BY_TEXT = [
    ...
    {
        "question": "📝 Как выглядит Ладья (Hisha)? Посмотрите на медиагруппу выше и выберите букву:",
        "images": ["kin.jpg", "kyo.jpg", "fu.jpg", "hisha.jpg"],
        "correct_letter": "D",
        "explanation": "Верно! Ладья (Hisha) — иероглиф 飛 (летать) очень сложный и узнаваемый."
    },
    {
        "question": "📝 Как выглядит Слон (Kakugyo)? Посмотрите на медиагруппу выше и выберите букву:",
        "images": ["kaku.jpg", "gin.jpg", "kei.jpg", "gyoku.jpg"],
        "correct_letter": "A",
        "explanation": "Верно! Слон (Kakugyo) — иероглиф 角 (угол) с характерной крышей сверху."
    },
    {
        "question": "📝 Как выглядит Серебряный генерал (Ginsho)? Посмотрите на медиагруппу выше и выберите букву:",
        "images": ["kyo.jpg", "gin.jpg", "hisha.jpg", "kaku.jpg"],
        "correct_letter": "B",
        "explanation": "Верно! Серебряный генерал — иероглиф 銀 (серебро) с четырьмя чертами снизу."
    },
    {
        "question": "📝 Как выглядит Копьеносец (Kyosha)? Посмотрите на медиагруппу выше и выберите букву:",
        "images": ["fu.jpg", "gyoku.jpg", "kyo.jpg", "kin.jpg"],
        "correct_letter": "C",
        "explanation": "Верно! Копьеносец — иероглиф 香 (благовоние), узкий и вытянутый."
    },
]
